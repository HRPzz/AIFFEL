...
|16|DL, NLP, Session-Based Recommendation, GRU4REC, MRR, Recall@k|다음에 볼 영화 예측하기 by 박지민|[📋]()|-|11|03.07|03.14|
...
|16|다음에 볼 영화 예측하기 by 박지민|고객이 바로 지금 원하는 것이 무엇인지를 예측하여 추천하는 Session-based Recommendation 개념을 익히고 실제로 모델을 구축해 본다.|
|17|난 스케치를 할 테니 너는 채색을 하거라 by 정신유|이미지 생성 모델로 사용되는 GAN 중에서 조건이 추가된 cGAN에 대해 알아보고 Pix2Pix를 배워봅니다.|
